...
process create_probe_config {
    ...
    def args_list = [
        ...
        create_bool_arg('--with_ks_filter', params.with_ks_filter),
        ...
        create_bool_arg('--ks_mask_bad_channels', params.ks_mask_bad_channels),
        ...
        create_arg('--pyks_preproc', params.pyks_preproc),
        create_arg('--pyks_alf', params.pyks_alf),
        create_arg('--ks_mode', params.ks_mode),
        create_arg('--ks_max_neighbors', params.ks_max_neighbors),
        create_bool_arg('--ks_no_drift_registration', params.ks_no_drift_registration),
        create_arg('--ks_sigma_mask', params.ks_sigma_mask),
        create_arg('--ks_fshigh', params.ks_fshigh),
        create_arg('--ks_fslow', params.ks_fslow),
        create_bool_arg('--ks_car', params.ks_car),
        ...
        create_bool_arg('--ks4_template_from_data', params.ks_template_from_data),
        create_bool_arg('--ks4_det', params.ks4_det),
        ...
        create_bool_arg('--catgt_sepShanks', params.catgt_sepShanks),
