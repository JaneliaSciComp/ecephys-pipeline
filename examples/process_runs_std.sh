...
foldername=SC048
DATA_DIR=/media/colonellj/DATAPART1/nf_ecephys/${foldername}
OUTPUT_DIR=/media/colonellj/DATAPART1/nf_ecephys/${foldername}_out
RUNS_SPECS_FILE=/media/colonellj/DATAPART1/nf_ecephys/${foldername}/${foldername}_runs.json

# name for log files
RUN_NAME=${foldername}_awspull_01
...
PARENT_DIR=/media/colonellj/DATAPART1/nf_ecephys
PARAM_DIR=/media/colonellj/DATAPART1/nf_ecephys/nf_scripts
WORKFLOW_DIR=/media/colonellj/DATAPART1/nf_ecephys/ecephys-pipeline
...
/media/colonellj/DATAPART1/nf_ecephys/nextflow run ${WORKFLOW_DIR}/main.nf \
    -profile standard \
