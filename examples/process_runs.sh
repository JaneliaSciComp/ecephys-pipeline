...
SINGULARITY_RUNTIME_OPTS="--nv --env MLM_LICENSE_FILE=27000@vm7142.int.janelia.org -B ${PARENT_DIR}"
#SINGULARITY_RUNTIME_OPTS="--nv -B ${PARENT_DIR} -B ${LOCAL_MODULES_DIR}:${CONTAINER_MODULES_DIR}"
