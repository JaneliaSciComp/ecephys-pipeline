...
class MeanWaveformParams(DefaultSchema):
    ...
    calc_half_run = Bool(require=False, default=True, help='calculate waveforms from two halves of run for UnitMatch')
    snr_radius = Int(require=False, default=8, help='disk radius (chans) about pk-chan for snr calculation in C_waves')
    snr_radius_um = Int(require=False, default=140, help='disk radius (um) about pk-chan for snr calculation in C_waves')
