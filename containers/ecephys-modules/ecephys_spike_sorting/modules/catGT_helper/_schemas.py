...
class CatGTParams(DefaultSchema):
    ...
    trigger_string = String(required=True, default='0,0',
                            help='string specifying trials to concatenate, e.g. 0,200')
    probe_string = String(required=True, default='0',
                          help='string specifying probes, e.g. 0:3')
    stream_string = String(required=True, default='-ap',
                           help='string specifying which streams to process')
    car_mode = String(require=False, default='None',
                      help='Comaon average reference mode. Must = None, gbldmx, or loccar ')
    loccar_inner = Int(require=False, default=2,
                       help='Inner radius for loccar in sites')
    loccar_outer = Int(require=False, default=8,
    ...
    useGeom = Bool(require=False, default=True, 
                       help='use snsGeomMap for loccar and depth')
    cmdStr = String(required=True, default='-prbfld -aphipass=300 -gbldmx -gfix=0.40,0.10,0.02',
