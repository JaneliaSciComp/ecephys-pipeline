...
from ...common.schemas import EphysParams, Directories, CommonFiles, NonValidatedInputDir
...
class Kilosort2Parameters(DefaultSchema):
    ...
    doFilter = Int(required=False, default=0, help='filter if = 1, skip bp filtering and CAR if = 0')
    fshigh = Float(required=False, default=150, help='frequency for high pass filtering')
...
class KilosortHelperParameters(DefaultSchema):
    ...
    ks_mask_bad_channels = Bool(required=False, default=True, help='If true, skip high noise channels')
