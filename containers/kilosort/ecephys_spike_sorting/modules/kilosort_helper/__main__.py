...
def run_kilosort(args):
    ...
    if args['kilosort_helper_params']['spikeGLX_data']:
        ...
        destFullPath = os.path.join(args['kilosort_helper_params']['matlab_home_directory'],
                                    'chanMap.mat')
    ...
    master_fullpath = os.path.join(os.path.join(args['kilosort_helper_params']['master_file_path'], 
                                                args['kilosort_helper_params']['master_file_name']))

    shutil.copyfile(master_fullpath,
                    os.path.join(args['kilosort_helper_params']['matlab_home_directory'], 
                                 args['kilosort_helper_params']['master_file_name']))
